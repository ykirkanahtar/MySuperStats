...
using MySuperStats.Authentication.External;
using MySuperStats.Authentication.JwtBearer;
...
namespace MySuperStats.Controllers
{
    ...
    public class TokenAuthController : MySuperStatsControllerBase
    {
        ...
        {
            return SimpleStringCipher.Instance.Encrypt(accessToken, MySuperStatsConsts.DefaultPassPhrase);
        }
    }
}
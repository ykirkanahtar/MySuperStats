...
{
    public abstract class MySuperStatsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MySuperStatsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MySuperStatsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MySuperStatsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MySuperStatsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MySuperStatsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MySuperStatsDbContext, Task<T>> func)
        {
            T result;

...
export class TenantServiceProxy {
     ...
     * @return Success
     */
    getAllForSessionUser(keyword: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TenantWithUserPermissionsDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/GetAllForSessionUser?";
        if (keyword !== undefined && keyword !== null)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetAllForSessionUser(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAllForSessionUser(<any>response_);
                } catch (e) {
                    return <Observable<TenantWithUserPermissionsDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<TenantWithUserPermissionsDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAllForSessionUser(response: HttpResponseBase): Observable<TenantWithUserPermissionsDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TenantWithUserPermissionsDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TenantWithUserPermissionsDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    loginToTenant(tenantId: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/LoginToTenant?";
        if (tenantId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processLoginToTenant(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processLoginToTenant(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processLoginToTenant(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    removeUserFromTenant(tenantId: number | undefined, userId: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Tenant/RemoveUserFromTenant?";
        if (tenantId === null)
            throw new Error("The parameter 'tenantId' cannot be null.");
        else if (tenantId !== undefined)
            url_ += "tenantId=" + encodeURIComponent("" + tenantId) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRemoveUserFromTenant(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRemoveUserFromTenant(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processRemoveUserFromTenant(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | null | undefined, sorting: string | null | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<TenantDtoPagedResultDto> {
...
export class TenantWithUserPermissionsDto implements ITenantWithUserPermissionsDto {
    id: number;
    tenancyName: string | undefined;
    name: string | undefined;
    isActive: boolean;
    ...
    constructor(data?: ITenantWithUserPermissionsDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TenantWithUserPermissionsDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantWithUserPermissionsDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TenantWithUserPermissionsDto {
        const json = this.toJSON();
        let result = new TenantWithUserPermissionsDto();
        result.init(json);
        return result;
...
export interface ITenantWithUserPermissionsDto {
    id: number;
    tenancyName: string | undefined;
    name: string | undefined;
    isActive: boolean;
...
export class TenantWithUserPermissionsDtoPagedResultDto implements ITenantWithUserPermissionsDtoPagedResultDto {
    totalCount: number;
    items: TenantWithUserPermissionsDto[] | undefined;

    constructor(data?: ITenantWithUserPermissionsDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(TenantWithUserPermissionsDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): TenantWithUserPermissionsDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new TenantWithUserPermissionsDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): TenantWithUserPermissionsDtoPagedResultDto {
        const json = this.toJSON();
        let result = new TenantWithUserPermissionsDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface ITenantWithUserPermissionsDtoPagedResultDto {
    totalCount: number;
    items: TenantWithUserPermissionsDto[] | undefined;
}
